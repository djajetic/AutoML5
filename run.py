...
# 	datan  m  mame/dataname_public.info        -- parameters of the data and task, including metric and time_budget
...
# This also allow  s us to plot learning curves. The last result is used by the
# scoring program.
...
# Modified by Damir Jajetic, November 2015

# =========================== BEGIN USER OPTIONS ==============================
# Verbose mode: 
##############
# Recommended to keep verbose = True: shows various progression messages
verbose = True # outputs messages to stdout and stajo12derr for debug purposes
...
# 4: just list the direct6ories and program version
debug_mode = 0
...
print "overall start",  time.ctime()
...
if __name__=="__main__" and debug_mode<4:	
	...
	print "total time spent ", time.time() - overall_start
	print "overall_time_budget ", overall_time_budget
